# Cấu hình kết nối database cho Docker environment
# File này sẽ được sử dụng khi chạy trong Docker container

DB_CONFIG = {
    'host': 'mysql',  # Tên service trong docker-compose
    'user': 'ktx_user',
    'password': 'ktx_secure_password',  # Không có password
...
# Cấu hình API cho Docker
API_CONFIG = {
    'host': '0.0.0.0',
    'port': 5000,  # Port trong container
